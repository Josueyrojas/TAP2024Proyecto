...
public class ClienteDAO{
    ...
    public int INSERT(){
        ...
        System.out.println("Consulta INSERT: " + query);  // Verifica la consulta SQL
        try{
    ...
    public ObservableList<ClienteDAO> SELECTALL(){
        ...
        try{
            ...
            while( res.next() ){
                ...
                objCte.emailCte = res.getString(4);  // Correo está en la posición 3
                objCte.telCte = res.getString(3);    // Teléfono está en la posición 4
                listaC.add(objCte);
            }
        }catch(Exception e){
            e.printStackTrace();
